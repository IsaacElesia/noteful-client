...
export default class App extends Component {
	...
	handleDeleteItem = (id) => {
		...
		fetch(`${config.API_ENDPOINT}/notes/${id}`, options).then(() =>
			this.setState({
	...
	handlePostNote = () => {
		...
		const folderid = this.state.folders.find(
	...
	render() {
		// so we made context.  When we use component={component}, that automatically creates render props.  they are still props.
		return (
				...
				<Fragment>
					...
					<ErrorPage>
						<Switch>
							...
							<Route exact path='/NoteForm' component={AddNote} />
							<Route exact path='/FolderForm' component={AddFolder} />
